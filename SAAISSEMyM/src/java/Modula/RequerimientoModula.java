    ...
    public void enviaRequerimiento(String F_IdFact) {
        ...
        try {
            ...
            try {
                ...
                ResultSet rset = con.consulta("select F_ClaCli, F_FecEnt, F_IdFact from v_folioremisiones where F_IdFact = '" + F_IdFact + "' and  F_StsFact=3 group by F_IdFact");
                while (rset.next()) {
                ...
                rset = con.consulta("select F_ClaCli, F_FecEnt, F_IdFact, F_ClaPro, F_ClaLot, F_FecCad, F_Cb, F_Cant, F_Id from v_folioremisiones where F_IdFact = '" + F_IdFact + "' and F_StsFact=3");
                while (rset.next()) {
                    /*
