                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <%
                                if (Cuenta == 0) {
                            %>
                            <label for="clave" class="col-sm-1 control-label">SICCAL</label>
                            <div class="col-sm-2">
                        ...
                        <br/>
                        <div class="row">
                            <label for="clave1" class="col-sm-1 control-label">SICCAL</label>
                            <div class="col-sm-2">
                                <input type="clave1" class="form-control" id="clave1" name="clave1" placeholder="SICCAL" value="<%=clave%>" readonly onKeyPress="return tabular(event, this)">
                            </div>
