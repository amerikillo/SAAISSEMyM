            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <h4>Caducidad: 
                        ...
                        <div style="width:100%; margin: auto" class="panel panel-body panel-info table-responsive">
                            <h3>Salidas desde Modula</h3>
                                ...
                                <tbody>
                                    <%
                                        try {
                                            conModula.conectar();
                                            con.conectar();
                                            ResultSet rset = conModula.consulta("select STO_ID, STO_TIME, STO_ORDINE, STO_ARTICOLO, STO_SUB1, STO_SUB2, STO_DSCAD, STO_QTAR, STO_UDC, STO_SCOMPARTO, STO_GIAC, STO_POSI from VIEW_MODULA_STORICO where STO_ARTICOLO = '" + Clave + "' and STO_SUB1 = '" + request.getParameter("Lote") + "' ");
                                            while (rset.next()) {
                                                String F_DesPro = "";
